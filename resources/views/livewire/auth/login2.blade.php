<div>
    ...
    <form wire:submit="checklogin">
        ...
        <div class="row mt-3">
            ...
            <!-- /.col -->
            <div class="col-5">
                <button type="submit" class="btn btn-primary btn-block" wire:loading.attr="disabled" wire:target="checklogin">
                    <span wire:loading.remove wire.target="checklogin">Sign In</span>
                    <span wire:loading wire.target="checklogin"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Waiting...</span>
                </button>
            </div>
            <!-- /.col -->
        </div>
