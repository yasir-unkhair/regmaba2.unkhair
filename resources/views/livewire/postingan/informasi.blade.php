            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools pr-2">
                        <button type="button" onclick="document.location='{{ route('admin.informasi.add') }}'" class="btn btn-sm btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @foreach ($row->kategori as $kategori)
                                                <li><a href="{{ route('admin.kategori') }}">{{ $kategori->kategori }}</a></li>
                                            @endforeach
                                            </ol>
                                        </td>
                                        <td>
                                        ...
                                        <td>{{ $row->user->name ?? '' }}</td>
                                        <td>
                                            <a href="{{ route('admin.informasi.edit', $row->id) }}" class="btn btn-sm btn-warning">Edit</a>
