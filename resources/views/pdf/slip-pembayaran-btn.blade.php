...
<body>
    <table>
        <tr>
            <td {{-- style='width:20%;border-bottom:0px;border-right:0px;border-top:0px;border-left:0px;vertical-align: middle;text-align: center;text-align:center'>
                    <img src='{{ get_image(public_path('images/logo.jpg')) }}' height=50 width=50 /> --}} </td>
            <td
            ...
            <td {{-- style='width:20%;border-bottom:0px;border-right:0px;border-top:0px;border-left:0px;vertical-align: middle;text-align: center;text-align:center'>
                    <img src='{{ get_image(public_path('images/btn.jpeg')) }}' height=50 width=50 /> --}} </td>
        </tr>
    </table>
