            ...
            <td align='center'>
                <table class='content' width='100%' cellpadding='0' cellspacing='0' role='presentation'>
                    <tr>
                        <td class='header'>
                            <a href="#">
                                <img src="{{ $message->embed(public_path('images/unkhair.png')) }}" class="logo-icon"
                                    alt="logo"><br>
                            ...
                            <table class='inner-body' align='center' width='570' cellpadding='0' cellspacing='0'
                                ...
                                <tr>
                                    <td class='content-cell'>
                                        ...
                                        <p>
                                            Agar akun anda dapat digunakan silahkan <b>Aktivasi Akun</b> terlebih
                                            dahulu sebelum digunakan untuk proses login.
                                        </p>
                                        <!-- Button Login -->
                                            ...
                                            <tr>
                                                <td align='center'>
                                                    <table width='100%' b='' order='0' cellpadding='0'
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <a href='{{ route('registrasi.aktivasi', encode_arr(['nomor_peserta' => $peserta->nomor_peserta, 'id' => $peserta->id, 'password' => $peserta->pass])) }}'
